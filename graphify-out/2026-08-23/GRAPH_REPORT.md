...
## Corpus Check
- 402 files · ~294,426 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3785 nodes · 5109 edges · 348 communities (292 shown, 56 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ace5c180`
...
- grant-service/nest-cli.json
- project-service/nest-cli.json
- review-service/nest-cli.json
- Cancel Nodes
- Conditions (`when:`)
- React Aria Components & TailGrids Primitives in VN-RU Portal
- Cancel Nodes
- Conditions (`when:`)
- grant-service/package.json
...
## Communities (348 total, 56 thin omitted)

### Community 0 - "devDependencies"
Cohesion: 0.06
Nodes (31): eslint-config-prettier, @eslint/eslintrc, @eslint/js, eslint-plugin-prettier, globals, @nestjs/schematics, devDependencies, eslint-config-prettier (+23 more)
...
Cohesion: 0.10
Nodes (21): openid-client, dependencies, @nestjs/common, @nestjs/core, @nestjs/platform-express, openid-client, pg, @prisma/adapter-pg (+13 more)
...
Cohesion: 0.11
Nodes (24): collabCopy, CollaborationWorkspaceView(), Copy, ProposalDetail(), proposalDetailCopy, collab, useOpportunities(), useProposal() (+16 more)
...
Cohesion: 0.12
Nodes (23): configSchema, validateConfig(), SESSION_COOKIE_OPTIONS, MockAuthService, MockResponse, AuthenticatedUser, BeginLoginInput, BeginLoginResult (+15 more)
...
Cohesion: 0.08
Nodes (13): AuthGuard, isAuthenticatedUser(), Injectable, ProjectRepository, Inject, Injectable, BootstrapProjectDto, CreateMilestoneDto (+5 more)
...
Cohesion: 0.07
Nodes (33): AppModule, Module, SafeHttpExceptionFilter, Catch, bootstrap(), PublicationController, Controller, Get (+25 more)
...
Cohesion: 0.13
Nodes (19): KnowledgePage(), metadata, one(), Params, Props, PublicationPage(), PublicPublication, Props (+11 more)
...
Cohesion: 0.10
Nodes (26): AdminAuditPage(), auditCopy, AdminCatalogsPage(), catalogCopy, HERO_DYNAMIC_PHRASES, HERO_STATIC_TITLE, HomeMotion(), Locale (+18 more)
...
Cohesion: 0.18
Nodes (12): paginationSchema, roleAssignmentSchema, rolePermissionsSchema, userStatusSchema, uuidSchema, AuthenticatedRequestGuard, extractSessionCookie(), isRecord() (+4 more)
...
### Community 91 - "jest"
Cohesion: 0.15
Nodes (13): **/*.(t|j)s, jest, collectCoverageFrom, coverageDirectory, moduleFileExtensions, rootDir, testEnvironment, testRegex (+5 more)
...
Cohesion: 0.10
Nodes (28): ProjectDetail(), ProjectList(), projects, useProject(), useProjects(), message(), ProjectApiError, projectRepository (+20 more)

### Community 113 - "AuthenticationService"
Cohesion: 0.14
Nodes (3): Headers, AuthenticationService, Injectable
...
Cohesion: 0.23
Nodes (15): AuthSession, isAuthSession(), KnowledgeWorkspacePage(), one(), Params, WorkspacePage(), fetchDiscoverySection(), Fetcher (+7 more)

### Community 151 - "compilerOptions"
Cohesion: 0.11
Nodes (17): compilerOptions, declaration, emitDecoratorMetadata, esModuleInterop, experimentalDecorators, incremental, isolatedModules, module (+9 more)
...
Cohesion: 0.13
Nodes (16): L, Locale, Props, ExpertDetail, ExpertDetailResult, ExpertMatch, ExpertMatchesResult, DiscoveryError (+8 more)
...
### Community 193 - "exclude"
Cohesion: 0.22
Nodes (8): prisma.config.ts, exclude, extends, dist, node_modules, **/*.spec.ts, **/*.test.ts, ./tsconfig.json
...
### Community 197 - "exclude"
Cohesion: 0.25
Nodes (7): exclude, extends, dist, node_modules, **/*.spec.ts, **/*.test.ts, ./tsconfig.json

### Community 198 - "exclude"
Cohesion: 0.25
Nodes (7): exclude, extends, dist, node_modules, **/*.spec.ts, **/*.test.ts, ./tsconfig.json
...
### Community 214 - "grant-service/nest-cli.json"
Cohesion: 0.33
Nodes (5): collection, compilerOptions, deleteOutDir, $schema, sourceRoot

### Community 215 - "project-service/nest-cli.json"
Cohesion: 0.33
Nodes (5): collection, compilerOptions, deleteOutDir, $schema, sourceRoot

### Community 216 - "review-service/nest-cli.json"
Cohesion: 0.33
Nodes (5): collection, compilerOptions, deleteOutDir, $schema, sourceRoot
...
### Community 222 - "grant-service/package.json"
Cohesion: 0.40
Nodes (4): name, packageManager, private, version

### Community 223 - "project-service/package.json"
Cohesion: 0.40
Nodes (4): name, packageManager, private, version

### Community 224 - "review-service/package.json"
Cohesion: 0.40
Nodes (4): name, packageManager, private, version
...
Cohesion: 0.12
Nodes (17): CopyType, dimensions, reviewDetailCopy, ReviewList(), reviewListCopy, reviews, useReviewAssignment(), useReviewAssignments() (+9 more)
...
Cohesion: 0.26
Nodes (11): checkUuid(), ProjectController, Body, Controller, Get, Param, Patch, Post (+3 more)

### Community 239 - "RolePermissionsPage.tsx"
Cohesion: 0.09
Nodes (31): copy, MfaControl(), ProfileDialog(), SecurityClientPage(), securityCopy, groupLabels, groupPermissions(), iamAdminCopy (+23 more)
...
Cohesion: 0.26
Nodes (4): AuthenticatedUser, ProjectService, Injectable, ReviewDto
...
### Community 273 - "motion"
Cohesion: 0.21
Nodes (22): AddMemberDto, CompleteDto, DeliverableDto, isBoundedString(), isUuid(), parseAddMemberDto(), parseBootstrapDto(), parseCompleteDto() (+14 more)
...
### Community 276 - "@tanstack/react-query"
Cohesion: 0.17
...
Cohesion: 0.25
Nodes (6): Badge(), BadgeProps, badgeStyles, BreadcrumbItem, Breadcrumbs(), BreadcrumbsProps
...
### Community 297 - "app.module.ts"
Cohesion: 0.31
Nodes (5): AppModule, Module, SafeHttpExceptionFilter, Catch, bootstrap()
...
### Community 305 - "tooltip.tsx"
Cohesion: 0.40
Nodes (3): Tooltip(), TooltipProps, TooltipTrigger()

### Community 306 - "1. THE THREE DIALS (Core Configuration)"
Cohesion: 0.50
...
### Community 309 - "3. Public / Workspace / Governance"
Cohesion: 0.50
Nodes (4): 3.1. Public / Discovery, 3.2. Role-based Workspace, 3.3. Governance & Administration, 3. Public / Workspace / Governance
...
## Knowledge Gaps
- **2129 isolated node(s):** `auditCopy`, `catalogCopy`, `copy`, `securityCopy`, `Params` (+2124 more)
...
- **Why does `useLocale` connect `useLocale` to `knowledge/types.ts`, `publications/types.ts`, `RolePermissionsPage.tsx`, `sweetalert2`, `@tanstack/react-query`, `Sidebar.tsx`, `@nestjs/testing`, `WorkspaceShell.tsx`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `Header()` connect `useLocale` to `sweetalert2`, `dependencies`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `react` connect `dependencies` to `useLocale`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
