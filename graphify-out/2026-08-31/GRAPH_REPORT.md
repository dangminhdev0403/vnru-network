# Graph Report - vnru-network  (2026-08-31)

## Corpus Check
- 348 files · ~1,296,681 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2477 nodes · 3455 edges · 237 communities (199 shown, 38 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f0f16980`
...
## Communities (237 total, 38 thin omitted)
...
### Community 2 - "workspace-server.ts"
Cohesion: 0.12
...
Cohesion: 0.22
Nodes (15): Page(), generateMetadata(), Page(), PageProps, GuestNewsArticleV2(), getOfficialNewsArticle(), NEWS_TITLE_NAMES, newsArticleHref() (+7 more)
...
Cohesion: 0.20
Nodes (9): AdminNewsController, parse(), Body, Delete, Param, Patch, Post, Req (+1 more)
...
Cohesion: 0.14
Nodes (13): ProfileDialog(), schema, iam, security, useProfile(), iamRepository, IamSession, json() (+5 more)
...
Cohesion: 0.10
Nodes (21): NavSection, shellCopy, WorkspaceShell(), SheetContent(), SheetContentProps, SheetOverlay(), SheetOverlayProps, SheetProps (+13 more)
...
Cohesion: 0.12
Nodes (13): metadata, GuestContactV2(), COPY, GuestOpportunitiesV2(), BRAND_TITLE, COPY, GuestNavActive, GuestPublicNav() (+5 more)

### Community 46 - "GuestHomeV2.tsx"
Cohesion: 0.12
Nodes (11): DEFAULT_FALLBACK_IMAGES, ECOSYSTEM_ORB_IMAGES, HERO_BANNERS, HOME_COPY, NETWORK_DESKTOP_NODES, NETWORK_TONE_STYLES, NetworkStat, Category (+3 more)
...
### Community 50 - "useLocale"
Cohesion: 0.10
Nodes (18): metadata, Copy, NotFoundClient(), Locale, useLocale, AccessLogsPage(), copy, SAMPLE_LOGS (+10 more)

### Community 51 - "AdminNewsStudio.tsx"
Cohesion: 0.11
Nodes (26): AdminNewsStudio(), categories, contentTypes, dateTimeValue(), empty(), formatAuthor(), formatDate(), initial (+18 more)
...
### Community 54 - "Architecture/README.md"
Cohesion: 0.15
...
### Community 110 - "identity.module.ts"
Cohesion: 0.17
...
### Community 111 - "authentication.service.ts"
Cohesion: 0.17
Nodes (12): AuthenticatedRequestGuard, extractSessionCookie(), isRecord(), Injectable, SESSION_COOKIE_OPTIONS, UserProfile, AuthenticatedUser, AuthenticationService (+4 more)
...
### Community 133 - "GuestExploreV2.tsx"
Cohesion: 0.23
Nodes (11): DEFAULT_FALLBACK_IMAGES, GuestExploreV2(), matchesContentType(), matchesPeriod(), matchesScope(), NewsItem, SmallRow(), TEXT (+3 more)

### Community 134 - "Portal Foundation Decisions"
Cohesion: 0.50
Nodes (3): Access model, Current product boundary, Portal Foundation Decisions

### Community 135 - "import-fixture.ts"
Cohesion: 0.29
...
### Community 139 - "app/news/page.tsx"
Cohesion: 0.19
...
### Community 144 - "GUIDES.md"
Cohesion: 0.12
Nodes (8): Task Guide Router, Deployment and Local Operation, Local source development, Production Compose deployment, Frontend Module Guide, Database Migration Guide, Multilingual Backend Plan, Backend Module Guide
...
### Community 165 - "import-official-news.ts"
Cohesion: 0.50
...
### Community 171 - "identity.module.ts"
Cohesion: 0.23
...
### Community 173 - "Header.tsx"
Cohesion: 0.18
Nodes (12): Header(), headerCopy, HeaderProps, auth, authResource, CurrentUser, json(), useLogout() (+4 more)

### Community 174 - "table.tsx"
Cohesion: 0.23
Nodes (11): TableBody(), TableCell(), tableCellStyles, TableHead(), TableHeader(), tableHeaderStyles, tableHeadStyles, TableRoot() (+3 more)

### Community 175 - "server.ts"
Cohesion: 0.24
...
Cohesion: 0.19
Nodes (10): copy, RegisterPage(), createRegistrationSchema(), isRegistrationField(), RegistrationField, RegistrationValidationCopy, BrandMark(), BrandMarkProps (+2 more)

### Community 188 - "news.controller.ts"
Cohesion: 0.17
...
### Community 202 - "NotFoundClient.tsx"
Cohesion: 0.27
...
### Community 208 - "news.service.ts"
Cohesion: 0.18
Nodes (9): adminArticleSelect, AdminListNewsInput, AdminNewsListResponse, articleSelect, NewsContentType, NewsLocale, NewsPrismaClient, NewsStatus (+1 more)

### Community 215 - "RoleDetailPage.tsx"
Cohesion: 0.15
Nodes (11): PageProps, AccessOverviewDashboard(), copy, quickActions, copy, GrantFilter, isSystemRole(), RoleDetailPage() (+3 more)

### Community 216 - "getCurrentSession"
Cohesion: 0.25
Nodes (6): BreadcrumbItem, Breadcrumbs(), BreadcrumbsProps, Button(), ButtonProps, buttonStyles

### Community 217 - "ProfileDialog.tsx"
Cohesion: 0.22
...
### Community 220 - "Pro-Max Verification Guide — Selectable Test Profiles"
Cohesion: 0.29
...
### Community 221 - "NewsService"
Cohesion: 0.38
Nodes (3): NewsService, Inject, Injectable

## Knowledge Gaps
- **1322 isolated node(s):** `PageProps`, `metadata`, `metadata`, `Copy`, `metadata` (+1317 more)
...
- **Why does `useLocale` connect `useLocale` to `authServiceUrl`, `Locale`, `GuestExploreV2.tsx`, `public-news-server.ts`, `PublicDiscoveryPages.tsx`, `confirmAction`, `GuestEcosystemV2.tsx`, `GuestAboutV2.tsx`, `WorkspaceSidebar.tsx`, `WorkspaceShell.tsx`, `opportunities.ts`, `Header.tsx`, `GuestHomeV2.tsx`, `server.ts`, `SidebarFrame.tsx`, `NotFoundClient.tsx`, `RolePermissionsPage.tsx`, `UserAdministration.tsx`, `LanguageSwitcher.tsx`, `RoleDetailPage.tsx`, `getCurrentSession`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `WorkspaceShell.tsx`, `table.tsx`, `server.ts`, `SidebarFrame.tsx`, `useLocale`, `getCurrentSession`, `ProfileDialog.tsx`, `auth.ts`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Locale` connect `useLocale` to `Locale`, `WorkspaceShell.tsx`, `PublicDiscoveryPages.tsx`, `RolePermissionsPage.tsx`, `UserAdministration.tsx`, `Header.tsx`, `GuestHomeV2.tsx`, `server.ts`, `confirmAction`, `LanguageSwitcher.tsx`, `SidebarFrame.tsx`, `GuestEcosystemV2.tsx`, `opportunities.ts`, `RoleDetailPage.tsx`, `GuestAboutV2.tsx`, `NotFoundClient.tsx`, `WorkspaceSidebar.tsx`?**
...
- **Should `workspace-server.ts` be split into smaller, more focused modules?**
