...
## Corpus Check
- 190 files · ~157,220 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1607 nodes · 1998 edges · 141 communities (123 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `254d4de6`
...
Cohesion: 0.11
Nodes (12): Res, extractSessionCookie(), isRecord(), AuthenticationController, Body, Controller, Get, Post (+4 more)
...
Cohesion: 0.16
Nodes (7): Delete, Optional, Param, UseGuards, SessionService, Inject, Injectable
