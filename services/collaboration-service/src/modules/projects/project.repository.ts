...
import { PrismaClient, ProjectStatus, ResourceRole, MilestoneStatus, ReportStatus } from '../../generated/projects';
...
export class ProjectRepository {
  constructor(@Inject('PROJECT_PRISMA') private readonly prisma: PrismaClient) {}
