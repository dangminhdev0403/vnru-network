  ...
  return (
    <div className="min-h-screen bg-[#06152f] text-white font-sans selection:bg-blue-600 selection:text-white">
      ...
      <main id="top">
          ...
          <div className="mx-auto max-w-6xl relative z-10">
            <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
              ...
              <div className="relative min-h-110 rounded-3xl border border-white/15 bg-[#0c1e38] p-6 shadow-2xl backdrop-blur-xl">
                {/* Floating Tags */}
                <div className="absolute -top-3.5 left-4 z-20 hidden sm:block rounded-lg border border-white/15 bg-[#0c1e38]/95 px-3 py-1.5 text-xs font-bold text-white shadow-md backdrop-blur-md">
                  <strong className="text-white">RU–VN</strong> Knowledge Graph
                </div>
                <div className="absolute top-44 -right-3 z-20 hidden sm:block rounded-lg border border-white/15 bg-[#0c1e38]/95 px-3 py-1.5 text-xs font-bold text-white shadow-md backdrop-blur-md">
                  Expert Matching · Semantic Search
                </div>
                <div className="absolute -bottom-3 left-10 z-20 hidden sm:block rounded-lg border border-white/15 bg-[#0c1e38]/95 px-3 py-1.5 text-xs font-bold text-white shadow-md backdrop-blur-md">
                  2+2 Cooperation Signals
                </div>
        ...
        <section id="network" className="relative overflow-hidden bg-[#06152f] px-4 py-20 text-white sm:px-6 sm:py-28">
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
              ...
              <div>
                <p className="text-base leading-relaxed text-slate-300">
                  <strong className="text-white">{t("Mỗi chuyên gia không đứng một mình.")}</strong>{" "}
                  {t("Hồ sơ của họ được đặt trong ngữ cảnh của công bố, chủ đề nghiên cứu, tổ chức, dự án và những chuyên gia liên quan. Từ một điểm dữ liệu, Portal mở ra toàn bộ chuỗi quan hệ để người dùng khám phá tri thức và tìm cơ hội hợp tác Nga – Việt.")}
                </p>
                <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div className="rounded-2xl border border-white/12 bg-white/5 p-4">
                    <strong className="block text-sm font-bold text-white">{t("Tri thức có ngữ cảnh")}</strong>
                    <span className="mt-1 block text-xs text-slate-300">{t("Công bố → tác giả → chủ đề → tổ chức → dự án.")}</span>
                  </div>
                  <div className="rounded-2xl border border-white/12 bg-white/5 p-4">
                    <strong className="block text-sm font-bold text-white">{t("Chuyên gia có quan hệ")}</strong>
                    <span className="mt-1 block text-xs text-slate-300">{t("Chuyên môn, hướng nghiên cứu và công bố tạo tín hiệu ghép nối.")}</span>
                  </div>
                  <div className="rounded-2xl border border-white/12 bg-white/5 p-4">
                    <strong className="block text-sm font-bold text-white">{t("Kết nối xuyên biên giới")}</strong>
                    <span className="mt-1 block text-xs text-slate-300">{t("Khám phá các quan hệ phù hợp giữa hệ sinh thái Việt Nam và Liên bang Nga.")}</span>
                  </div>
                  <div className="rounded-2xl border border-white/12 bg-white/5 p-4">
                    <strong className="block text-sm font-bold text-white">{t("Từ khám phá đến hợp tác")}</strong>
                    <span className="mt-1 block text-xs text-slate-300">{t("Mạng lưới tri thức là lớp dẫn đường tới đối tác, consortium và dự án song phương.")}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Network Map Canvas */}
            <div className="relative mt-12 min-h-[560px] overflow-hidden rounded-3xl border border-white/15 bg-[#0c1e38]/70 shadow-2xl backdrop-blur-xl" aria-label="Mô hình mạng lưới tri thức Nga - Việt">
              <svg className="absolute inset-0 h-full w-full" viewBox="0 0 1180 610" preserveAspectRatio="none" aria-hidden="true">
                <defs>
                ...
                <path className="fill-none stroke-white/20 stroke-[1.4] [stroke-dasharray:5_10]" d="M135 130 C250 145,270 265,430 290" />
                <path className="fill-none stroke-white/20 stroke-[1.4] [stroke-dasharray:5_10]" d="M160 300 C270 290,320 305,430 290" />
                <path className="fill-none stroke-white/20 stroke-[1.4] [stroke-dasharray:5_10]" d="M145 475 C250 430,320 350,430 290" />
                <path className="fill-none stroke-white/20 stroke-[1.4] [stroke-dasharray:5_10]" d="M390 108 C420 170,445 220,505 268" />
                <path className="fill-none stroke-white/20 stroke-[1.4] [stroke-dasharray:5_10]" d="M390 500 C435 430,470 365,505 320" />
                <path className="fill-none stroke-[url(#bridgeGradient)] stroke-2 opacity-90" d="M505 292 C590 250,660 250,745 292" />
                <path className="fill-none stroke-white/20 stroke-[1.4] [stroke-dasharray:5_10]" d="M745 292 C855 250,900 150,1010 125" />
                <path className="fill-none stroke-white/20 stroke-[1.4] [stroke-dasharray:5_10]" d="M745 292 C875 292,900 300,1035 300" />
                <path className="fill-none stroke-white/20 stroke-[1.4] [stroke-dasharray:5_10]" d="M745 292 C850 350,900 430,1015 485" />
                <path className="fill-none stroke-white/20 stroke-[1.4] [stroke-dasharray:5_10]" d="M680 268 C725 210,760 165,805 105" />
                <path className="fill-none stroke-white/20 stroke-[1.4] [stroke-dasharray:5_10]" d="M680 320 C720 382,755 445,805 510" />
                <path className="fill-none stroke-white/20 stroke-[1.4] [stroke-dasharray:5_10]" d="M160 300 C360 380,810 380,1035 300" />
              </svg>

              <div className="absolute -translate-x-1/2 -translate-y-1/2 min-w-[124px] rounded-xl border border-white/18 bg-[#0c1e38]/95 p-2.5 shadow-lg" style={{ left: "11%", top: "21%" }}>
                <strong className="block text-xs font-bold text-white">{t("Công bố khoa học")}</strong>
                <span className="text-[11px] text-slate-300">{t("Publication · VN")}</span>
              </div>
              <div className="absolute -translate-x-1/2 -translate-y-1/2 min-w-[124px] rounded-xl border border-white/18 bg-[#0c1e38]/95 p-2.5 shadow-lg" style={{ left: "13%", top: "49%" }}>
                <strong className="block text-xs font-bold text-white">{t("Chuyên gia Việt Nam")}</strong>
                <span className="text-[11px] text-slate-300">{t("Expert · Researcher")}</span>
              </div>
              <div className="absolute -translate-x-1/2 -translate-y-1/2 min-w-[124px] rounded-xl border border-white/18 bg-[#0c1e38]/95 p-2.5 shadow-lg" style={{ left: "12%", top: "77%" }}>
                <strong className="block text-xs font-bold text-white">{t("Viện / Trường VN")}</strong>
                <span className="text-[11px] text-slate-300">{t("Organization")}</span>
              </div>
              <div className="absolute -translate-x-1/2 -translate-y-1/2 min-w-[124px] rounded-xl border border-white/18 bg-[#0c1e38]/95 p-2.5 shadow-lg" style={{ left: "33%", top: "17%" }}>
                <strong className="block text-xs font-bold text-white">{t("Chủ đề nghiên cứu")}</strong>
                <span className="text-[11px] text-slate-300">{t("Knowledge Topic")}</span>
              </div>
              <div className="absolute -translate-x-1/2 -translate-y-1/2 min-w-[124px] rounded-xl border border-white/18 bg-[#0c1e38]/95 p-2.5 shadow-lg" style={{ left: "33%", top: "81%" }}>
                <strong className="block text-xs font-bold text-white">{t("Dự án & Công nghệ")}</strong>
                <span className="text-[11px] text-slate-300">{t("Project · Technology")}</span>
              </div>

              {/* Core Knowledge Hub */}
              <div className="absolute -translate-x-1/2 -translate-y-1/2 w-[190px] min-h-[92px] grid place-items-center rounded-2xl border-2 border-white/30 bg-[#071831] p-3 text-center shadow-xl" style={{ left: "50%", top: "48%" }}>
                <div>
                  <strong className="block text-sm font-bold text-white">{t("RU–VN Knowledge Network")}</strong>
                  <span className="mt-1 block text-[10px] text-slate-300">{t("Identity · Knowledge · Expertise · Cooperation")}</span>
                </div>
              </div>

              <div className="absolute -translate-x-1/2 -translate-y-1/2 min-w-[124px] rounded-xl border border-white/18 bg-[#0c1e38]/95 p-2.5 shadow-lg" style={{ left: "68%", top: "17%" }}>
                <strong className="block text-xs font-bold text-white">{t("Research Domain")}</strong>
                <span className="text-[11px] text-slate-300">{t("Shared expertise")}</span>
              </div>
              <div className="absolute -translate-x-1/2 -translate-y-1/2 min-w-[124px] rounded-xl border border-white/18 bg-[#0c1e38]/95 p-2.5 shadow-lg" style={{ left: "68%", top: "82%" }}>
                <strong className="block text-xs font-bold text-white">{t("Joint Project")}</strong>
                <span className="text-[11px] text-slate-300">{t("Cooperation opportunity")}</span>
              </div>
              <div className="absolute -translate-x-1/2 -translate-y-1/2 min-w-[124px] rounded-xl border border-white/18 bg-[#0c1e38]/95 p-2.5 shadow-lg" style={{ left: "86%", top: "20%" }}>
                <strong className="block text-xs font-bold text-white">{t("Scientific Publication")}</strong>
                <span className="text-[11px] text-slate-300">{t("Publication · RU")}</span>
              </div>
              <div className="absolute -translate-x-1/2 -translate-y-1/2 min-w-[124px] rounded-xl border border-white/18 bg-[#0c1e38]/95 p-2.5 shadow-lg" style={{ left: "88%", top: "49%" }}>
                <strong className="block text-xs font-bold text-white">{t("Chuyên gia Liên bang Nga")}</strong>
                <span className="text-[11px] text-slate-300">{t("Expert · Researcher")}</span>
              </div>
              <div className="absolute -translate-x-1/2 -translate-y-1/2 min-w-[124px] rounded-xl border border-white/18 bg-[#0c1e38]/95 p-2.5 shadow-lg" style={{ left: "86%", top: "79%" }}>
                <strong className="block text-xs font-bold text-white">{t("Viện / Trường Nga")}</strong>
                <span className="text-[11px] text-slate-300">{t("Organization")}</span>
              </div>
              ...
              <div className="absolute bottom-4 left-4 right-4 z-10 flex flex-col sm:flex-row items-center justify-between gap-3 rounded-xl border border-white/15 bg-[#071831]/95 px-4 py-3 text-xs text-white">
                <div>
                  ...
                  <span className="text-slate-300">{t("· từ dữ liệu khoa học phân tán đến quan hệ có thể khám phá và hành động.")}</span>
                </div>
                <div className="flex flex-wrap items-center gap-4 text-[11px] font-semibold text-slate-200">
                  <span className="flex items-center gap-1.5">
                    <span className="h-2 w-2 rounded-full bg-[#1c57d7]" /> {t("Việt Nam")}
                  </span>
                  <span className="flex items-center gap-1.5">
                    <span className="h-2 w-2 rounded-full bg-[#dc2626]" /> {t("Liên bang Nga")}
                  </span>
                  <span className="flex items-center gap-1.5">
                    <span className="h-2 w-2 rounded-full bg-linear-to-r from-[#1c57d7] to-[#dc2626]" /> {t("Liên kết song phương")}
                  </span>
                </div>
              </div>
            </div>
