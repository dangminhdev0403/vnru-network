          ...
          <div className="ml-auto flex shrink-0 items-center gap-2 sm:gap-3 lg:ml-0">
            ...
            {isAuthenticated ? (
              <a
                ...
                className="inline-flex h-9 items-center rounded-lg border border-white/20 bg-white/10 px-3 text-xs font-bold text-white transition hover:bg-white/20 sm:px-4"
              >
                {locale === "ru"
                  ? "Выйти →"
                  : locale === "en"
