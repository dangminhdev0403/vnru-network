...
> = {
  vi: {
    ...
    revokeBtn: "Thu hồi",
    modalSignOutTitle: "Đăng xuất?",
    modalRevokeTitle: "Thu hồi phiên?",
    modalSignOutDesc: "Quay lại trang đăng nhập.",
    modalRevokeDesc: "Ngắt kết nối thiết bị này.",
    cancelBtn: "Hủy",
    confirmSignOutBtn: "Đăng xuất",
    confirmRevokeBtn: "Thu hồi",
    modalOthersTitle: "Thu hồi thiết bị khác?",
    modalOthersDesc: "Đăng xuất các thiết bị khác, giữ lại phiên này.",
    confirmRevokeOthersBtn: "Thu hồi",
    toastRevokedOthers: "Đã thu hồi các thiết bị khác",
  ...
  ru: {
    ...
    modalRevokeDesc:
      "Это устройство будет немедленно отключено от РОССИЙСКО-ВЬЕТНАМСКОЙ ИНТЕЛЛЕКТУАЛЬНОЙ СЕТИ.",
    cancelBtn: "Отмена",
