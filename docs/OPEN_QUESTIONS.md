...
| **OPEN-07** | **Project Milestone & Progress Acceptance Hierarchy**<br>Who has authority to submit, review, and approve research project milestones and progress reports (e.g., Lead Researcher, Organization Representative, Foundation Program Manager)? | Project / PMS | Affects `project-service` workflow states, approval chains, and role-based milestone sign-offs. | Unresolved |
